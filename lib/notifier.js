...
/**
 * Where the merchant/admin receipt goes. Server-side environment only — a
...
function extractMerchantContact(trx, payload) {
  ...
  console.log(`${LOG_PREFIX} Merchant contact for ${merchantName}: phone ${phone ? 'configured' : 'none'}, email ${email || 'none'}`);
